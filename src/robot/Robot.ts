...
import { Direction, directionsForTurnLeft, directionsForTurnRight, type RobotCoordinate } from './types.js';
import { InvalidCoordinatesError } from './table.errors.js';
...
export class Robot {
	...
	place(newCoordinates: RobotCoordinate, newDirection: Direction): void {
